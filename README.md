...
Full script: [`Zepto_SQL_Solved.sql`](Zepto_SQL_Solved.sql)
...
| File | Description |
|---|---|
| [`Zepto_SQL_Solved.sql`](Zepto_SQL_Solved.sql) | Full SQL script — table creation, data cleaning, and business queries |
| [`zepto.pbit`](zepto.pbit) | Power BI template file — open in Power BI Desktop |
